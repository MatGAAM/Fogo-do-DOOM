...
function updateFireIntensityPerPixel(currentPixelIndex){
    ...
    switch (sentido){
        case 0: firePixelArray[currentPixelIndex - decay] = newFireIntensity; break;
        case 1: firePixelArray[currentPixelIndex] = newFireIntensity; break;
        case 2: firePixelArray[currentPixelIndex + decay] = newFireIntensity; break;
    }
}
...
function decreaseFireSource(){
    for ( let column = 0; column <= fireWidth ; column ++){
        ...
        if (currentFireIntensity > 0){
            ...
            const newFireIntensity =
             currentFireIntensity - decrease >= 0 ?  currentFireIntensity - decrease :0
